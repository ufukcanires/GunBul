def tarih_bulma():
    ...
    gun=int(input("Lütfen gününü giriniz:"))
    ay=int(input("Lütfen ayını giriniz:"))
    ay=sozluk2[ay]
    ay_kodu=sozluk3[ay]
    yıl=input("Lütfen yıl giriniz:")
    yıl_2=yıl[2:4]
    yıl_2=int(yıl_2)
    yıl=int(yıl)
    if yıl >= 1700 and yıl < 1800 :
        yuzyıl=4
    ...
    if artık_yıl ==1:
        if ay=="Ocak" or ay=="Şubat":
            ...
            artık_yıl=0
    gun_numarası=((yıl_kodu+ay_kodu+yuzyıl+gun-artık_yıl)%7)
